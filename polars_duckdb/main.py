...
import polars as pl
import yaml
from core import calculate_summary_statistics, load_data, plot_data_distribution
...
def main():
    parser = argparse.ArgumentParser(
        description="Basic data analysis — Polars + DuckDB"
    )
    ...
    for col in df.columns:
        plot_data_distribution(
            df, col, f"Distribution of {col}", output_dir / f"distribution_{col}.png"
        )
